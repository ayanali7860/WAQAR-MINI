...
const BOT_NAME_FANCY = '𝚆𝚊𝚚𝚊𝚛 𝙼𝚒𝚗𝚒 𝚇 𝙼𝙳';
...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://files.catbox.moe/otbham.jpg',
  NEWSLETTER_JID: [
      '120363425072775595@newsletter', // WAQAR MINI BOT V1
      '120363425072775595@newsletter', // WAQAR MINI BOT V1
      '120363425072775595@newsletter',//WAQAR MINI BOT V1
      '120363425072775595@newsletter',//WAQAR MINI BOT V1
      '120363425072775595@newsletter'//WAQAR MINI BOT V1
  ...
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',') : ['923356191137', '923356191137'],
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbCPbGu6BIEkqj1GAZ3G',
  BOT_NAME: '© 𝚆𝚊𝚚𝚊𝚛 𝙼𝚒𝚗𝚒 𝚇 𝙼𝙳',
  BOT_VERSION: '3.0.0 ULTRA',
  OWNER_NAME: '@𝙒𝙖𝙦𝙖𝙧 𝙈𝙞𝙣𝙞 𝘿𝙚𝙫',
  IMAGE_PATH: 'https://files.catbox.moe/otbham.jpg',
  BOT_FOOTER: '> *© 𝚆𝚊𝚚𝚊𝚛 𝙼𝚒𝚗𝚒 𝚇 𝙼𝙳*',
...
const MONGO_DB = process.env.MONGO_DB || 'WAQAR_MINI_SAR';
...
case 'alive': {
        ...
        case 'owner': {
          try { await socket.sendMessage(sender, { react: { text: "🥷", key: msg.key } }); } catch (e) {}
          const owners = [{ name: "☠︎︎ 𝚆𝚊𝚚𝚊𝚛 𝙼𝚒𝚗𝚒 ᴅᴇᴠ </> ☠︎︎", number: "923356191137", email: "dula9x@gmail.com" }, { name: "❖ ─̲͞  ♥ 𝚆𝚊𝚚𝚊𝚛 𝙼𝚒𝚗𝚒🤍❖", number: "923356191137", email: "huiohui84@gmail.com" }, { name: "❖ ─̲͞  ♥ 𝚆𝚊𝚚𝚊𝚛 𝙼𝚒𝚗𝚒🤍❖", number: "923356191137", email: "huiohui84@gmail.com" }];
          const contactCards = owners.map(owner => ({ vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:${owner.name}\nORG:WAQAR MINI  X MD\nTEL;type=CELL;type=VOICE;waid=${owner.number}:${owner.number}\nEMAIL:${owner.email}\nEND:VCARD` }));
          await socket.sendMessage(sender, { contacts: { displayName: "WAQAR MINI  X MD Owners", contacts: contactCards } }, { quoted: msg });
          await socket.sendMessage(sender, { text: `╭━━〔 👑 *WAQAR MINI  X MD OWNER* 〕━━⬣\n┃ 📞 *☠︎︎ ᴅᴄᴛ ᴅᴜʟᴀ ᴅᴇᴠ </> ☠︎︎:* wa.me/923356191137\n┃ 📞 *❖ ─̲͞  ♥ ᴍᴀᴅᴜꜱᴀɴᴋᴀ🤍❖:* wa.me/923356191137\n┃ 📧 *Email:* waqarmini@gmail.com\n┃ 📧 *Email:* huiohui84@gmail.com\n╰━━━━━━━━━━━━━━⬣` });
          break;
        }
...
🔹 *BOT NAME:*  ${cfg.botName || 'WAQAR MINI  X MD'}
   .setbotname <name>
          ...
          try {
            ...
            if (!channelLink || !channelLink.trim()) {
              return await socket.sendMessage(sender, {
                text: `❌ *Channel Link Required!*\n\n📝 Usage: .channelinfo <channel_link>\n\n🔗 *Examples:*\n• .channelinfo https://whatsapp.com/channel/0029VbBivQGBKfi1VaWyEd0t\n• .channelinfo 120363407179960904@newsletter`
              }, { quoted: msg });
            }
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: 'WAQAR MINI  X MD BOT', activesession: activeSockets.size });
});
